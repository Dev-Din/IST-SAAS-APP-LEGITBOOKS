...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-6">
        ...
        <form method="POST" action="{{ route('tenant.invoices.store') }}" class="bg-white shadow-sm rounded-lg p-6">
            @csrf
                    ...
                    <div class="line-item border rounded p-4 mb-4">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="line_items[0][tax_rate]" value="0" step="0.01" min="0" max="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            </div>
                            <div>
