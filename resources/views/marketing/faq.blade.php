...
<section class="bg-white py-12 sm:py-16 w-full overflow-x-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="text-center">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 px-2">Frequently Asked Questions</h1>
            <p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-2">Find answers to common questions about LegitBooks.</p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="space-y-3 sm:space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(1)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">What is included in the free trial?</span>
                ...
                <div id="content-1" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <!-- FAQ Item 2 -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(2)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">How does billing work?</span>
                    <svg id="icon-2" class="h-5 w-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div id="content-2" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <!-- FAQ Item 3 -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(3)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">Is my data secure?</span>
                    <svg id="icon-3" class="h-5 w-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div id="content-3" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <!-- FAQ Item 4 -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(4)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">Can multiple users access the same account?</span>
                    <svg id="icon-4" class="h-5 w-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div id="content-4" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <!-- FAQ Item 5 -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(5)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">How do I cancel my subscription?</span>
                    <svg id="icon-5" class="h-5 w-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div id="content-5" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <!-- FAQ Item 6 -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <button class="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center focus:outline-none" onclick="toggleFaq(6)">
                    <span class="text-base sm:text-lg font-semibold text-gray-900 pr-2">Does LegitBooks integrate with M-Pesa?</span>
                    <svg id="icon-6" class="h-5 w-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div id="content-6" class="hidden px-4 sm:px-6 pb-3 sm:pb-4">
...
<section class="py-12 sm:py-16 bg-gray-900 w-full overflow-x-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4 px-2">Still have questions?</h2>
        <p class="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 px-2">Contact our support team and we'll be happy to help.</p>
